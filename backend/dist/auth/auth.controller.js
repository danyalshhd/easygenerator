...
let AuthController = class AuthController {
    ...
    async requestForgotPassword(resetPasswordDto) {
        return await this.authService.forgotPasswordRequest(resetPasswordDto.email);
    }
    async ressetPassword(resetPasswordDto, req) {
        return await this.authService.resetPassword(resetPasswordDto.password, req.user.id);
    }
};
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [auth_dto_1.ResetPasswordRequestDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AuthController.prototype, "ressetPassword", null);
